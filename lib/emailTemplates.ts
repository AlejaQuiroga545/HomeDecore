            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
              ...
              <tr>
                <td style="padding: 40px 40px 30px; text-align: center; background-color: #ffffff;">
                  <h1 style="margin: 0; font-size: 32px; font-weight: 700; color: ${brandColors.primary}; letter-spacing: -0.5px;">HomeDecor</h1>
                </td>
              </tr>
            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
              ...
              <tr>
                <td style="padding: 0 40px 40px;">
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" style="margin: 0 0 24px; background-color: ${brandColors.cream}; border-radius: 8px; border-left: 3px solid ${brandColors.accent};">
                    <tr>
...
// Generate contact confirmation email template (sent to user)
        ...
        <tr>
          <td align="center">
            <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
              ...
              <tr>
                <td style="padding: 0 40px 40px;">
                  <h2 style="margin: 0 0 20px; font-size: 24px; font-weight: 600; color: #1a1a1a; line-height: 1.3;">¡Mensaje recibido!</h2>
                  
                  <p style="margin: 0 0 16px; font-size: 16px; font-weight: 400; color: #333333; line-height: 1.6;">Hola ${safeName},</p>
                  
                  <p style="margin: 0 0 24px; font-size: 16px; font-weight: 400; color: #4a4a4a; line-height: 1.6;">Gracias por contactarnos. Hemos recibido tu mensaje y nuestro equipo se pondrá en contacto contigo pronto.</p>
                  
                  <!-- Info Box -->
                  <table width="100%" cellpadding="0" cellspacing="0" style="margin: 0 0 32px; background-color: ${brandColors.cream}; border-radius: 8px; border-left: 3px solid ${brandColors.accent};">
                    <tr>
                      <td style="padding: 20px;">
                        <p style="margin: 0 0 12px; font-size: 14px; font-weight: 600; color: #1a1a1a; line-height: 1.5;">¿Qué sigue?</p>
                        <p style="margin: 0 0 8px; font-size: 14px; font-weight: 400; color: #4a4a4a; line-height: 1.6;">• Revisaremos tu mensaje en las próximas 24 horas</p>
                        <p style="margin: 0 0 8px; font-size: 14px; font-weight: 400; color: #4a4a4a; line-height: 1.6;">• Te responderemos a la dirección de correo que proporcionaste</p>
                        <p style="margin: 0; font-size: 14px; font-weight: 400; color: #4a4a4a; line-height: 1.6;">• Si es urgente, puedes llamarnos al +57 314 297 0157</p>
                      </td>
                    </tr>
                  </table>
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" style="margin: 0 0 32px;">
                    <tr>
                      <td align="center">
                        <a href="${baseUrl}/shop" style="display: inline-block; background-color: ${brandColors.accent}; color: #ffffff; padding: 14px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; letter-spacing: 0.3px;">Explorar tienda</a>
                      </td>
                    </tr>
                  </table>
                  
                  <p style="margin: 0; font-size: 16px; font-weight: 400; color: #4a4a4a; line-height: 1.6;">Mientras tanto, puedes explorar nuestra colección de muebles y decoración.</p>
                </td>
              </tr>
              ...
              <tr>
                <td style="padding: 30px 40px; background-color: #fafafa; border-top: 1px solid #e5e5e5;">
                  <p style="margin: 0; font-size: 13px; font-weight: 400; color: #666666; text-align: center; line-height: 1.5;">© 2025 HomeDecor. Todos los derechos reservados.</p>
                </td>
              </tr>
            </table>
          </td>
            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
              ...
              <tr>
                <td style="padding: 0 40px 40px;">
                  ...
                  <!-- Login Time Box -->
                  <table width="100%" cellpadding="0" cellspacing="0" style="margin: 0 0 32px; background-color: ${brandColors.cream}; border-radius: 8px; border-left: 3px solid ${brandColors.warm};">
                    <tr>
